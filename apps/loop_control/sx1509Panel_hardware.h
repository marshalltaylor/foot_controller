#ifndef SX1509PANEL_HARDWARE_H
#define SX1509PANEL_HARDWARE_H
#include "Arduino.h"
...
class sx1509Hardware
{
public:
    sx1509Hardware(void);

    void init(uint8_t); // pass address, flasher mask pointers
    void setAddress(uint8_t);

    void update(void);

    void pinMode(uint8_t pin,
                 uint8_t mode); // mode is OUTPUT, INPUT_PULLUP, INPUT

    // Set / get pins, then call update() to refresh
...
private:
    ...
    void         readBytes(uint8_t  firstRegisterAddress,
                           uint8_t *destination,
                           uint8_t  length);
    // Write functions:
...
/*
        ...
        license: Beerware. Feel free to use it, with or without attribution, in
                your own projects. If you find it helpful, buy me a beer next
   time you see me at the local pub.
*/

#define REG_INPUT_DISABLE_B \
    0x00 //	RegInputDisableB Input buffer disable register _ I/O[15_8] (Bank
         // B) 0000 0000
#define REG_INPUT_DISABLE_A \
    0x01 //	RegInputDisableA Input buffer disable register _ I/O[7_0] (Bank
         // A) 0000 0000
#define REG_LONG_SLEW_B \
    0x02 //	RegLongSlewB Output buffer long slew register _ I/O[15_8] (Bank
         // B) 0000 0000
#define REG_LONG_SLEW_A \
    0x03 //	RegLongSlewA Output buffer long slew register _ I/O[7_0] (Bank
         // A) 0000 0000
#define REG_LOW_DRIVE_B \
    0x04 //	RegLowDriveB Output buffer low drive register _ I/O[15_8] (Bank
         // B) 0000 0000
#define REG_LOW_DRIVE_A \
    0x05 //	RegLowDriveA Output buffer low drive register _ I/O[7_0] (Bank
         // A) 0000 0000
#define REG_PULL_UP_B \
    0x06 //	RegPullUpB Pull_up register _ I/O[15_8] (Bank B) 0000 0000
#define REG_PULL_UP_A \
    0x07 //	RegPullUpA Pull_up register _ I/O[7_0] (Bank A) 0000 0000
#define REG_PULL_DOWN_B \
    0x08 //	RegPullDownB Pull_down register _ I/O[15_8] (Bank B) 0000 0000
#define REG_PULL_DOWN_A \
    0x09 //	RegPullDownA Pull_down register _ I/O[7_0] (Bank A) 0000 0000
#define REG_OPEN_DRAIN_B \
    0x0A //	RegOpenDrainB Open drain register _ I/O[15_8] (Bank B) 0000 0000
#define REG_OPEN_DRAIN_A \
    0x0B //	RegOpenDrainA Open drain register _ I/O[7_0] (Bank A) 0000 0000
#define REG_POLARITY_B \
    0x0C //	RegPolarityB Polarity register _ I/O[15_8] (Bank B) 0000 0000
#define REG_POLARITY_A \
    0x0D //	RegPolarityA Polarity register _ I/O[7_0] (Bank A) 0000 0000
#define REG_DIR_B \
    0x0E //	RegDirB Direction register _ I/O[15_8] (Bank B) 1111 1111
#define REG_DIR_A \
    0x0F //	RegDirA Direction register _ I/O[7_0] (Bank A) 1111 1111
#define REG_DATA_B \
    0x10 //	RegDataB Data register _ I/O[15_8] (Bank B) 1111 1111*
#define REG_DATA_A \
    0x11 //	RegDataA Data register _ I/O[7_0] (Bank A) 1111 1111*
#define REG_INTERRUPT_MASK_B \
    0x12 //	RegInterruptMaskB Interrupt mask register _ I/O[15_8] (Bank B)
         // 1111 1111
#define REG_INTERRUPT_MASK_A \
    0x13 //	RegInterruptMaskA Interrupt mask register _ I/O[7_0] (Bank A)
         // 1111 1111
#define REG_SENSE_HIGH_B \
    0x14 //	RegSenseHighB Sense register for I/O[15:12] 0000 0000
#define REG_SENSE_LOW_B \
    0x15 //	RegSenseLowB Sense register for I/O[11:8] 0000 0000
#define REG_SENSE_HIGH_A \
    0x16 //	RegSenseHighA Sense register for I/O[7:4] 0000 0000
#define REG_SENSE_LOW_A \
    0x17 //	RegSenseLowA Sense register for I/O[3:0] 0000 0000
#define REG_INTERRUPT_SOURCE_B \
    0x18 //	RegInterruptSourceB Interrupt source register _ I/O[15_8] (Bank
         // B) 0000 0000
#define REG_INTERRUPT_SOURCE_A \
    0x19 //	RegInterruptSourceA Interrupt source register _ I/O[7_0] (Bank
         // A) 0000 0000
#define REG_EVENT_STATUS_B \
    0x1A //	RegEventStatusB Event status register _ I/O[15_8] (Bank B) 0000
         // 0000
#define REG_EVENT_STATUS_A \
    0x1B //	RegEventStatusA Event status register _ I/O[7_0] (Bank A) 0000
         // 0000
#define REG_LEVEL_SHIFTER_1 \
    0x1C //	RegLevelShifter1 Level shifter register 0000 0000
#define REG_LEVEL_SHIFTER_2 \
...
#define REG_LED_DRIVER_ENABLE_B \
    0x20 //	RegLEDDriverEnableB LED driver enable register _ I/O[15_8] (Bank
         // B) 0000 0000
#define REG_LED_DRIVER_ENABLE_A \
    0x21 //	RegLEDDriverEnableA LED driver enable register _ I/O[7_0] (Bank
         // A) 0000 0000
// Debounce and Keypad Engine
#define REG_DEBOUNCE_CONFIG \
    0x22 //	RegDebounceConfig Debounce configuration register 0000 0000
#define REG_DEBOUNCE_ENABLE_B \
    0x23 //	RegDebounceEnableB Debounce enable register _ I/O[15_8] (Bank B)
         // 0000 0000
#define REG_DEBOUNCE_ENABLE_A \
    0x24 //	RegDebounceEnableA Debounce enable register _ I/O[7_0] (Bank A)
         // 0000 0000
#define REG_KEY_CONFIG_1 \
    0x25 //	RegKeyConfig1 Key scan configuration register 0000 0000
#define REG_KEY_CONFIG_2 \
...
#define REG_T_RISE_15 \
    0x67 //	RegTRise15 Fade in register for I/O[15] 0000 0000
#define REG_T_FALL_15 \
    0x68 //	RegTFall15 Fade out register for I/O[15] 0000 0000
// 	Miscellaneous
#define REG_HIGH_INPUT_B \
    0x69 //	RegHighInputB High input enable register _ I/O[15_8] (Bank B)
         // 0000 0000
#define REG_HIGH_INPUT_A \
    0x6A //	RegHighInputA High input enable register _ I/O[7_0] (Bank A)
         // 0000 0000
//  Software Reset
